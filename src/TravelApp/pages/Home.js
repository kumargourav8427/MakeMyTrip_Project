...
function Home() {
  ...
  const [MultiWay, setMultiWay] = useState("");

  const tripSelectionOne = (event) => {
    setOneWay(event.target.value);
    document.getElementById("oneway");
    console.log("oneway");
  };
  const tripSelectionoRound = (event) => {
    setRoundTrip(event.target.value);
    document.getElementById("roundtrip");
    console.log("roundtrip");
  };
  const tripSelectionoMulti = (event) => {
    setMultiWay(event.target.value);
    document.getElementById("multitrip");
        ...
        <div className="container wrapper1 px-4">
          <div className="row">
            <div className="col-sm-6">
              <input
                ...
                name="options"
                value={OneWay}
                onClick={tripSelectionOne}
                id="oneway"
              ></input>
              <label className="p-1" for="oneway">
                One Way
              </label>
              <input
                type="radio"
                ...
                value={RoundTrip}
                id="roundtrip"
                onClick={tripSelectionoRound}
              ></input>
              <label className="p-1" for="roundtrip">
                Round Trip
              </label>
              <input
                type="radio"
                ...
                value={MultiWay}
                id="multitrip"
                onClick={tripSelectionoMulti}
              ></input>
              <label className="p-1" for="multitrip">
                Multi Way
              </label>
              {setOneWay === "Oneway" &&
                RoundTrip === "RoundTrip" &&
          ...
          <div className="row input_row">
            <div className="col-md-3 input_box ">
              ...
              <div className=" search_home_from">
                {city
                  .filter((item) => {
              ...
              <div className="pointer">
                <div>
                  <div className="" onClick={() => setShowModal(true)}>
                    ...
                    <p className="text-bold">Rooms and Adults</p>
                  </div>
                </div>
